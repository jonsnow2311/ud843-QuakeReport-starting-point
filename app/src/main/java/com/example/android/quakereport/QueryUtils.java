    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for( i=0 ; i < 10 ; i++)
            {
                ...
                jplace = properties.getString("place");
                jmag = properties.getDouble("mag");
                jtime = properties.getLong("time");
                jUrl = properties.getString("url");
                earthquakes.add(new Earthquake(jmag , jplace , jtime , jUrl));
